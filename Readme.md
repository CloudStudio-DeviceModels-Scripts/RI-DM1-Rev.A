...
# Parsing + Configuration Script – RI - DM1 - Rev. A

This **Parsing + Configuration** script is designed for the **RI - DM1** model in **Gear Studio**, part of the [Cloud Studio](https://www.cloud.studio/) platform.
...
# Script de Parsing + Configuration – RI - DM1 Rev. A

Este script de **Parsing + Configuration** está diseñado para el modelo **RI - DM1** en **Gear Studio**, parte de la plataforma [Cloud Studio](https://www.cloud.studio/).
